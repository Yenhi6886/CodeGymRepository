package com.codegym.customerrepository.controller;

import com.codegym.customerrepository.model.Customer;
import com.codegym.customerrepository.model.Province;
import com.codegym.customerrepository.service.ICustomerService;
import com.codegym.customerrepository.service.IProvinceService;
...
public class CustomerController {
    ...
    public ModelAndView listCustomersSearch(@RequestParam("search") Optional<String> search, Pageable pageable){
        ...
        if(search.isPresent()){
            customers = (Page<Customer>) customerService.findAllByFirstNameContaining(search.get(), pageable);
        } else {
